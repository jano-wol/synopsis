<template>
    ...
    <p>If you have any comments, questions, or suggestions, please contact us at the following address:<br>
    ...
    <p>
        The project includes a <a href="https://github.com/anwolosz/synopsis/wiki">wiki page</a> that documents the decisions, questions, and observations made during development. The <a href="https://github.com/anwolosz/synopsis/wiki/Errata">Errata</a> section contains errors identified by users.
    </p>
    <h2 class="fs-3">
        Development
    </h2>
